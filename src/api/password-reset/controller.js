...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Express Api Boilerplate account.<br>
        ...
        &mdash; Express Api Boilerplate Team
      `
      return sendMail({ toEmail: email, subject: 'Express Api Boilerplate - Password Reset', content })
    })
